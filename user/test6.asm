...
user/_test6:     file format elf64-littleriscv
...
main(int argc, char *argv[])
{
  ...
  86:	a80080e7          	jalr	-1408(ra) # b02 <ulthread_init>

    /* Create a user-level thread */
    uint64 args[6] = {6,5,4,3,2,1};
  8a:	00001797          	auipc	a5,0x1
  8e:	e0e78793          	addi	a5,a5,-498 # e98 <ulthread_context_switch+0x12e>
  92:	6388                	ld	a0,0(a5)
  94:	678c                	ld	a1,8(a5)
  96:	6b90                	ld	a2,16(a5)
  98:	6f94                	ld	a3,24(a5)
  9a:	7398                	ld	a4,32(a5)
  9c:	779c                	ld	a5,40(a5)
  9e:	fca43023          	sd	a0,-64(s0)
  a2:	fcb43423          	sd	a1,-56(s0)
  a6:	fcc43823          	sd	a2,-48(s0)
  aa:	fcd43c23          	sd	a3,-40(s0)
  ae:	fee43023          	sd	a4,-32(s0)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46c:	ac050513          	addi	a0,a0,-1344 # f28 <digits>
 470:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 570:	96470713          	addi	a4,a4,-1692 # ed0 <ulthread_context_switch+0x166>
 ...
 5fa:	932b8b93          	addi	s7,s7,-1742 # f28 <digits>
 ...
 64e:	87e90913          	addi	s2,s2,-1922 # ec8 <ulthread_context_switch+0x15e>
        while(*s != 0){
...
void roundRobin(void)
{
 ...
 8ce:	676c0c13          	addi	s8,s8,1654 # f40 <digits+0x18>
...
void firstComeFirstServe(void)
{
 ...
 9dc:	58850513          	addi	a0,a0,1416 # f60 <digits+0x38>
...
void priorityScheduling(void)
{
 ...
 ab4:	49050513          	addi	a0,a0,1168 # f40 <digits+0x18>
...
bool ulthread_create(uint64 start, uint64 stack, uint64 args[], int priority)
{
 ...
 bbc:	03090693          	addi	a3,s2,48
  {
    t->sp -= 16;
 bc0:	449c                	lw	a5,8(s1)
 bc2:	37c1                	addiw	a5,a5,-16 # ff0 <digits+0xc8>
 ...
 c1e:	37650513          	addi	a0,a0,886 # f90 <digits+0x68>
...
void ulthread_yield(void)
{
 ...
 ca4:	31850513          	addi	a0,a0,792 # fb8 <digits+0x90>
...
void ulthread_destroy(void)
{
 ...
 d3a:	29a50513          	addi	a0,a0,666 # fd0 <digits+0xa8>
